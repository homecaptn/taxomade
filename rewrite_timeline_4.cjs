...
<section id="how-it-works" class="py-20 bg-white overflow-hidden border-b border-slate-100">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative max-w-7xl mx-auto mt-24">
      ...
      <div class="hidden lg:block absolute top-[-60px] left-[1%] w-[18%] h-[20px] border-t-[3px] border-l-[3px] border-r-[3px] border-dashed border-indigo-300 rounded-t-xl z-0">
        <div class="absolute -top-6 left-1/2 -translate-x-1/2 bg-indigo-600 px-6 py-2 text-sm md:text-base font-black text-white tracking-widest whitespace-nowrap shadow-md rounded-full">NON-EU</div>
      </div>
      <!-- Standard Path Label -->
      ...
      <div class="grid grid-cols-1 md:grid-cols-5 gap-4 lg:gap-6 relative z-10 pt-8">
        ...
        <div class="flex flex-col h-full">
          <div id="timeline-step-visa" class="bg-indigo-50 p-5 lg:p-6 rounded-2xl border-2 border-indigo-200 shadow-sm transition-all duration-300 relative text-left flex flex-col items-start w-full flex-1 min-h-[320px] overflow-hidden pt-14">
            ...
            <div class="mt-auto w-full border-t border-indigo-200 pt-3">
