...
<section id="how-it-works" class="py-20 bg-white overflow-hidden border-b border-slate-100">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-28">
      <h2 class="text-3xl md:text-4xl font-bold text-slate-900 mb-4">What is Needed</h2>
    ...
    <div class="relative max-w-7xl mx-auto mt-24">
      ...
      <div class="grid grid-cols-1 md:grid-cols-5 gap-4 lg:gap-6 relative z-10 pt-8">
        ...
        <div class="flex flex-col items-center h-full">
          <div id="timeline-step-visa" class="bg-white p-5 lg:p-6 rounded-2xl border border-slate-200 shadow-sm transition-all duration-300 relative text-center flex flex-col items-center w-full flex-1 min-h-[400px] overflow-hidden">
            <!-- Number Badge -->
            <div class="absolute top-4 left-4 w-8 h-8 rounded-full bg-slate-900 text-white font-black flex items-center justify-center text-lg shadow-sm">1</div>
            <!-- Time Badge -->
            <div class="absolute top-4 right-4 bg-slate-100 text-slate-600 text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-md">Pre-arrival</div>

            <div class="h-16 w-16 bg-slate-50 border border-slate-200 text-slate-600 rounded-full flex items-center justify-center mb-6 mt-8 z-10 shrink-0">
        ...
        <!-- Step 2: AFM -->
        <div class="flex flex-col items-center h-full">
          <div class="bg-white p-5 lg:p-6 rounded-2xl border border-slate-200 shadow-sm relative text-center flex flex-col items-center w-full flex-1 transition-transform hover:-translate-y-1 min-h-[400px] overflow-hidden">
            <!-- Number Badge -->
            <div class="absolute top-4 left-4 w-8 h-8 rounded-full bg-slate-900 text-white font-black flex items-center justify-center text-lg shadow-sm">2</div>
            <!-- Time Badge -->
            <div class="absolute top-4 right-4 bg-slate-100 text-slate-600 text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-md">Arrival</div>

            <div class="h-16 w-16 bg-blue-50 border border-blue-100 text-blue-800 rounded-full flex items-center justify-center mb-6 mt-8 z-10 shrink-0">
        ...
        <!-- Step 3: 5C Tax Break -->
        <div class="flex flex-col items-center h-full">
          <div id="timeline-step-5c" class="bg-white p-5 lg:p-6 rounded-2xl border border-slate-200 shadow-sm relative text-center flex flex-col items-center w-full flex-1 transition-all duration-300 min-h-[400px] overflow-hidden">
            <!-- Number Badge -->
            <div class="absolute top-4 left-4 w-8 h-8 rounded-full bg-slate-900 text-white font-black flex items-center justify-center text-lg shadow-sm">3</div>
            <!-- Time Badge -->
            <div class="absolute top-4 right-4 bg-slate-100 text-slate-600 text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-md">Arrival</div>
        ...
        <div class="md:col-span-2 flex flex-col h-full relative">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 flex-1">
            ...
            <!-- Step 4: Bookkeeping -->
            <div id="timeline-step-bookkeeping" class="bg-white p-5 lg:p-6 rounded-2xl border border-slate-200 shadow-sm relative text-center flex flex-col items-center w-full transition-all duration-300 min-h-[400px] overflow-hidden">
              <!-- Number Badge -->
              <div class="absolute top-4 left-4 w-8 h-8 rounded-full bg-slate-900 text-white font-black flex items-center justify-center text-lg shadow-sm">4</div>
              <!-- Time Badge -->
            ...
            <div id="timeline-step-taxreturn" class="bg-white p-5 lg:p-6 rounded-2xl border border-slate-200 shadow-sm relative text-center flex flex-col items-center w-full transition-all duration-300 min-h-[400px] overflow-hidden">
              <!-- Number Badge -->
              <div class="absolute top-4 left-4 w-8 h-8 rounded-full bg-slate-900 text-white font-black flex items-center justify-center text-lg shadow-sm">5</div>
              <!-- Time Badge -->
              <div class="absolute top-4 right-4 bg-slate-100 text-slate-600 text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-md">Ongoing</div>
