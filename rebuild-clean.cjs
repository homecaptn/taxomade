...
const headerHtml = `---
---
<!-- Absolutely NO background color or transition, perfectly transparent -->
<header id="site-header" class="fixed w-full top-0 z-50">
    ...
    <div class="flex justify-between items-center h-20">
      ...
      <div class="hidden md:flex items-center space-x-8 ml-auto">
        <nav class="flex items-center space-x-8">
          <a href="#how-it-works" class="text-slate-900 hover:text-blue-700 font-bold drop-shadow-md transition-colors">How it works</a>
          <a href="#services" class="text-slate-900 hover:text-blue-700 font-bold drop-shadow-md transition-colors">Services</a>
          
          <!-- Countries Dropdown -->
          <div class="relative group py-2">
            <button class="text-slate-900 hover:text-blue-700 font-bold drop-shadow-md transition-colors flex items-center">
              Countries
          ...
          <a href="#prices" class="text-slate-900 hover:text-blue-700 font-bold drop-shadow-md transition-colors">Prices</a>
        </nav>
        
        <a href="#configurator" class="inline-flex items-center justify-center pl-5 pr-3 py-2 text-sm font-bold rounded-lg text-slate-900 bg-white hover:bg-slate-200 transition-colors duration-200 group shadow-lg border border-slate-200">
          <span class="mr-3">Talk to us</span>
          <div class="flex -space-x-1.5">
            <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white group-hover:ring-slate-100 object-cover" src="https://randomuser.me/api/portraits/men/32.jpg" alt="Support Staff 1" />
            <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white group-hover:ring-slate-100 object-cover" src="https://randomuser.me/api/portraits/women/44.jpg" alt="Support Staff 2" />
          </div>
        </a>
      </div>
...
<section class="relative pt-32 pb-20 md:pt-40 md:pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-white">
  ...
  <!-- Background Image with new Acropolis. No filters, full sharpness. -->
  <div class="absolute inset-0 z-0 overflow-hidden">
    <div class="absolute inset-0 bg-[url('/images/acropolis-new.jpg')] bg-cover bg-center bg-no-repeat w-full h-full"></div>
  </div>

  <div class="max-w-7xl mx-auto relative z-10 mt-8">
    <div class="flex flex-col items-start relative">
      
      <!-- Left: Text content (Dark Text with drop shadow, no backgrounds) -->
      <div class="text-left relative z-20 w-full drop-shadow-lg">
        <h1 class="text-[2.75rem] sm:text-5xl md:text-6xl lg:text-[4.5rem] font-black tracking-tight text-slate-900 mb-8 leading-[1.1]">
          <div class="whitespace-nowrap drop-shadow-md">Relocate to Greece.</div>
          <div class="whitespace-nowrap flex items-baseline drop-shadow-md">
            <span class="text-slate-900 mr-3">We handle</span>
            <span class="word-spinner text-blue-700 text-left w-[7em] md:w-[8em] inline-block">
              <span>taxes.</span>
              <span>visas.</span>
        ...
        <!-- Absolutely NO background block here -->
        <p class="text-xl md:text-2xl text-slate-800 mb-10 max-w-2xl font-bold drop-shadow-md">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-start gap-4">
          <a href="#configurator" class="inline-flex items-center justify-center px-8 py-4 text-lg font-bold rounded-lg text-white bg-blue-700 hover:bg-blue-800 transition-colors duration-200 w-full sm:w-auto shadow-xl">
            Start to relocate
          </a>
          <a href="#contact" class="inline-flex items-center justify-center px-8 py-4 text-lg font-bold rounded-lg text-slate-900 bg-white hover:bg-slate-100 transition-colors duration-200 w-full sm:w-auto shadow-lg border border-slate-200">
            Book a free call
          </a>
        </div>
      </div>
