...
<section class="relative pt-32 pb-20 md:pt-40 md:pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
  ...
  <!-- Background Image with Acropolis (No darkening overlay) -->
  <div class="absolute inset-0 z-0 overflow-hidden bg-slate-900">
    <!-- Using the acropolis_bg generated earlier -->
    <div class="absolute inset-0 bg-[url('/images/acropolis-bg.png')] bg-cover bg-center scale-105"></div>
  </div>
    ...
    <div class="flex flex-col items-start relative">
      ...
      <div class="text-left relative z-20 w-full drop-shadow-lg">
        ...
        <h1 class="text-[2.75rem] sm:text-5xl md:text-6xl lg:text-[4.5rem] font-black tracking-tight text-white mb-8 leading-[1.1]">
          <div class="whitespace-nowrap drop-shadow-xl">Relocate to Greece.</div>
          <div class="whitespace-nowrap flex items-baseline drop-shadow-xl">
            <span class="text-white mr-3">We handle</span>
            <span class="word-spinner text-blue-500 text-left w-[7em] md:w-[8em] inline-block">
              <span>taxes.</span>
              <span>visas.</span>
        ...
        <p class="text-xl md:text-2xl text-slate-100 mb-10 max-w-2xl font-medium drop-shadow-md">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-start gap-4">
          <a href="#configurator" class="inline-flex items-center justify-center px-8 py-4 text-lg font-bold rounded-lg text-slate-900 bg-white hover:bg-slate-200 transition-colors duration-200 w-full sm:w-auto shadow-lg">
            Start to relocate
          </a>
          <a href="#contact" class="inline-flex items-center justify-center px-8 py-4 text-lg font-bold rounded-lg text-white bg-transparent border-2 border-white hover:bg-white hover:text-slate-900 transition-colors duration-200 w-full sm:w-auto shadow-lg">
            Book a free call
          </a>
        </div>
      </div>
