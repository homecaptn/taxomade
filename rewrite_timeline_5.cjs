    ...
    <div class="relative max-w-7xl mx-auto mt-24">
      ...
      <div class="grid grid-cols-1 md:grid-cols-5 gap-4 lg:gap-6 relative z-10 pt-8">
        ...
        <div class="flex flex-col h-full">
          <div id="timeline-step-visa" class="bg-blue-50 p-5 lg:p-6 pt-16 rounded-2xl border-2 border-blue-200 shadow-sm transition-all duration-300 relative text-left flex flex-col items-start w-full flex-1 min-h-[320px] overflow-hidden">
            ...
            <div class="mt-auto w-full border-t border-blue-200 pt-3">
        ...
        <!-- Step 2: AFM -->
        <div class="flex flex-col h-full">
          <div class="bg-white p-5 lg:p-6 pt-16 rounded-2xl border border-slate-200 shadow-sm relative text-left flex flex-col items-start w-full flex-1 transition-transform hover:-translate-y-1 min-h-[320px] overflow-hidden">
        ...
        <!-- Step 3: 5C Tax Break -->
        <div class="flex flex-col h-full">
          <div id="timeline-step-5c" class="bg-white p-5 lg:p-6 pt-16 rounded-2xl border border-slate-200 shadow-sm relative text-left flex flex-col items-start w-full flex-1 transition-all duration-300 min-h-[320px] overflow-hidden">
            
            <h3 class="text-xl md:text-2xl font-black text-slate-900 mb-4 leading-tight">50% Tax Reduction (5C)</h3>
            <ul class="text-sm text-slate-600 text-left space-y-2 mb-4 list-disc pl-4 flex-grow">
              <li>Article 5C eligibility check</li>
              <li>Income tax reduction for 7 yrs</li>
              <li>Application & document submission</li>
            </ul>
          </div>
        </div>
        ...
        <div class="md:col-span-2 flex flex-col h-full relative">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 flex-1">
            ...
            <!-- Step 4: Bookkeeping -->
            <div id="timeline-step-bookkeeping" class="bg-white p-5 lg:p-6 pt-16 rounded-2xl border border-slate-200 shadow-sm relative text-left flex flex-col items-start w-full transition-all duration-300 min-h-[320px] overflow-hidden">
            ...
            <div id="timeline-step-taxreturn" class="bg-white p-5 lg:p-6 pt-16 rounded-2xl border border-slate-200 shadow-sm relative text-left flex flex-col items-start w-full transition-all duration-300 min-h-[320px] overflow-hidden">
