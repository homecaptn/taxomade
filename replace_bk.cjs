const fs = require('fs');
const file = 'src/pages/greece/ongoing-bookkeeping.astro';
let content = fs.readFileSync(file, 'utf8');

const replacement = `    <!-- Section 3: Split Timeline -->
    <section class="max-w-5xl mx-auto mb-24 px-4 sm:px-0">
      <h2 class="text-3xl md:text-5xl font-black text-slate-900 mb-16 text-center tracking-tight">How it works — you send your numbers, we do the rest</h2>
          ...
          <div class="relative flex flex-col md:flex-row items-start md:items-center">
            <div class="md:w-1/2 flex justify-start md:justify-end pl-16 md:pl-0 md:pr-12 w-full mb-4 md:mb-0">
               <div class="bg-white border border-slate-100 rounded-xl p-5 shadow-sm w-full md:max-w-[280px] relative z-10">
                  ...
                  <p class="text-sm text-slate-600">Say yes and sign the authorization.</p>
               </div>
            </div>
            ...
            <div class="md:w-1/2 pl-16 md:pl-12 w-full">
               <div class="bg-blue-50 border border-blue-100 rounded-2xl p-6 shadow-md w-full md:max-w-[400px] relative z-10 border-l-4 border-l-blue-600">
                  ...
                  <h4 class="text-sm font-bold text-slate-900 mb-1">One-time setup</h4>
                  <p class="text-lg font-bold text-slate-900 leading-snug">We register your freelancer status, EFKA, VAT and e-invoicing.</p>
               </div>
            </div>
          </div>
          ...
          <div class="relative flex flex-col md:flex-row items-start md:items-center">
            <div class="md:w-1/2 flex justify-start md:justify-end pl-16 md:pl-0 md:pr-12 w-full mb-4 md:mb-0">
               <div class="bg-white border border-slate-100 rounded-xl p-5 shadow-sm w-full md:max-w-[280px] relative z-10">
                  <div class="flex justify-between items-center mb-2">
                    <span class="text-xs font-bold uppercase tracking-wider text-slate-400">You</span>
                    <span class="text-xs font-mono font-medium text-slate-400 bg-slate-50 px-2 py-0.5 rounded-md">~5 min</span>
                  </div>
                  <p class="text-sm text-slate-600">Send us your invoices and income.</p>
               </div>
            </div>
            ...
            <div class="md:w-1/2 pl-16 md:pl-12 w-full">
               <div class="bg-emerald-50 border border-emerald-100 rounded-2xl p-6 shadow-md w-full md:max-w-[400px] relative z-10 border-l-4 border-l-emerald-500">
                  ...
                  <h4 class="text-sm font-bold text-slate-900 mb-1">Each month</h4>
                  <p class="text-lg font-bold text-slate-900 leading-snug">We file your myDATA, EFKA, VAT and issue compliant e-invoices.</p>
               </div>
            </div>
          </div>
          ...
          <div class="relative flex flex-col md:flex-row items-start md:items-center">
            <div class="md:w-1/2 flex justify-start md:justify-end pl-16 md:pl-0 md:pr-12 w-full mb-4 md:mb-0">
               <div class="bg-white border border-slate-100 rounded-xl p-5 shadow-sm w-full md:max-w-[280px] relative z-10">
                  ...
                  <p class="text-sm text-slate-600">Nothing — we already have it.</p>
               </div>
            </div>
            ...
            <div class="md:w-1/2 pl-16 md:pl-12 w-full">
               <div class="bg-blue-50 border border-blue-100 rounded-2xl p-6 shadow-md w-full md:max-w-[400px] relative z-10 border-l-4 border-l-blue-600">
                  <div class="text-xs font-black uppercase tracking-wider text-blue-800 mb-2">Taxomade handles</div>
                  <h4 class="text-sm font-bold text-slate-900 mb-1">Year-end</h4>
                  <p class="text-lg font-bold text-slate-900 leading-snug">We file your annual accounts and tax return, with a plain-English summary.</p>
               </div>
            </div>
          </div>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden relative transform transition duration-300 hover:-translate-y-1 hover:shadow-2xl">
          ...
          <div class="p-8 h-full flex flex-col">
            <h3 class="text-2xl font-bold text-slate-900 mb-2">Freelancer Accounting</h3>
            <p class="text-slate-500 mb-6 flex-grow">Complete monthly bookkeeping, tax, and social security compliance.</p>
            <div class="flex items-baseline mb-8">
              <span class="text-5xl font-black text-slate-900">€149</span>
              <span class="text-slate-500 ml-2">/ month</span>
            </div>
            <ul class="space-y-4 mb-8">
              <li class="flex items-start text-slate-700"><svg class="w-5 h-5 text-emerald-500 mr-3 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Monthly myDATA reporting & VAT returns</li>
              <li class="flex items-start text-slate-700"><svg class="w-5 h-5 text-emerald-500 mr-3 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> EFKA (social security) management</li>
              <li class="flex items-start text-slate-700"><svg class="w-5 h-5 text-emerald-500 mr-3 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Annual Greek tax return included</li>
              <li class="flex items-start text-slate-700"><svg class="w-5 h-5 text-emerald-500 mr-3 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> E-invoicing setup & support</li>
            </ul>
            <a href="/#configurator" class="block w-full py-4 px-6 bg-slate-100 hover:bg-slate-200 text-slate-900 font-bold rounded-xl transition-colors duration-200 text-center">Start your bookkeeping</a>
          </div>
        </div>
