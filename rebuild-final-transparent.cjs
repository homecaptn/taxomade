...
const headerHtml = `---
---
<!-- Completely transparent background forever, dark text -->
<header id="site-header" class="fixed w-full top-0 z-50 bg-transparent">
    ...
    <div class="flex justify-between items-center h-20">
      ...
      <div class="hidden md:flex items-center space-x-8 ml-auto">
        <nav class="flex items-center space-x-8">
          <a href="#how-it-works" class="text-slate-800 hover:text-blue-700 font-bold drop-shadow-sm transition-colors">How it works</a>
          <a href="#services" class="text-slate-800 hover:text-blue-700 font-bold drop-shadow-sm transition-colors">Services</a>
          
          <!-- Countries Dropdown -->
          <div class="relative group py-2">
            <button class="text-slate-800 hover:text-blue-700 font-bold drop-shadow-sm transition-colors flex items-center">
              Countries
          ...
          <a href="#prices" class="text-slate-800 hover:text-blue-700 font-bold drop-shadow-sm transition-colors">Prices</a>
        </nav>
        
        <!-- White Button for high contrast -->
        <a href="#configurator" class="inline-flex items-center justify-center pl-5 pr-3 py-2 text-sm font-bold rounded-lg text-slate-900 bg-white hover:bg-slate-200 transition-colors duration-200 group shadow-md border border-slate-200/50">
...
<section class="relative pt-32 pb-20 md:pt-40 md:pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-white">
  ...
  <div class="absolute inset-0 z-0 overflow-hidden">
    <div class="absolute inset-0 bg-[url('/images/acropolis-final.jpg')] bg-cover bg-center bg-no-repeat w-full h-full"></div>
  </div>

  <div class="max-w-7xl mx-auto relative z-10 mt-8">
    <div class="flex flex-col items-start relative">
      
      <!-- Left: Text content (Dark Text with subtle glow/shadow for perfect readability) -->
      <div class="text-left relative z-20 w-full drop-shadow-md">
        ...
        <p class="text-xl md:text-2xl text-slate-800 mb-10 max-w-2xl font-bold bg-white/30 backdrop-blur-sm p-4 rounded-xl border border-white/40 shadow-sm">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-start gap-4">
          ...
          <a href="#contact" class="inline-flex items-center justify-center px-8 py-4 text-lg font-bold rounded-lg text-slate-900 bg-white/90 backdrop-blur-md hover:bg-white transition-colors duration-200 w-full sm:w-auto shadow-lg border border-slate-200">
            Book a free call
          </a>
        </div>
      </div>
