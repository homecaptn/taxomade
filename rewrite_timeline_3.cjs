  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative max-w-7xl mx-auto mt-24">
      ...
      <div class="hidden lg:block absolute top-[-60px] left-[1%] w-[18%] h-[20px] border-t-[3px] border-l-[3px] border-r-[3px] border-dashed border-slate-300 rounded-t-xl z-0">
        <div class="absolute -top-6 left-1/2 -translate-x-1/2 bg-white px-6 py-2 text-sm md:text-base font-black text-slate-600 tracking-widest whitespace-nowrap border-2 border-slate-200 shadow-sm rounded-full">NON-EU</div>
      </div>
      <!-- Standard Path Label -->
      ...
      <div class="grid grid-cols-1 md:grid-cols-5 gap-4 lg:gap-6 relative z-10 pt-8">
        ...
        <div class="flex flex-col h-full">
          <div id="timeline-step-visa" class="bg-white p-5 lg:p-6 rounded-2xl border border-slate-200 shadow-sm transition-all duration-300 relative text-left flex flex-col items-start w-full flex-1 min-h-[380px] overflow-hidden">
            ...
            <div class="h-12 w-12 bg-slate-50 border border-slate-200 text-slate-600 rounded-xl flex items-center justify-center mb-6 z-10 shrink-0">
              <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            </div>
            <h3 class="text-xl md:text-2xl font-black text-slate-900 mb-4 leading-tight">Digital Nomad Visa</h3>
        ...
        <!-- Step 2: AFM -->
        <div class="flex flex-col h-full">
          <div class="bg-white p-5 lg:p-6 rounded-2xl border border-slate-200 shadow-sm relative text-left flex flex-col items-start w-full flex-1 transition-transform hover:-translate-y-1 min-h-[380px] overflow-hidden">
            
            <div class="h-12 w-12 bg-blue-50 border border-blue-100 text-blue-800 rounded-xl flex items-center justify-center mb-6 z-10 shrink-0">
        ...
        <!-- Step 3: 5C Tax Break -->
        <div class="flex flex-col h-full">
          <div id="timeline-step-5c" class="bg-white p-5 lg:p-6 rounded-2xl border border-slate-200 shadow-sm relative text-left flex flex-col items-start w-full flex-1 transition-all duration-300 min-h-[380px] overflow-hidden">
            ...
            <h3 class="text-xl md:text-2xl font-black text-slate-900 mb-4 leading-tight">50% Tax Break</h3>
            <ul class="text-sm text-slate-600 text-left space-y-2 mb-4 list-disc pl-4 flex-grow">
        ...
        <div class="md:col-span-2 flex flex-col h-full relative">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 flex-1">
            ...
            <!-- Step 4: Bookkeeping -->
            <div id="timeline-step-bookkeeping" class="bg-white p-5 lg:p-6 rounded-2xl border border-slate-200 shadow-sm relative text-left flex flex-col items-start w-full transition-all duration-300 min-h-[380px] overflow-hidden">
              ...
              <h3 class="text-xl md:text-2xl font-black text-slate-900 mb-4 leading-tight">Registration & Bookkeeping</h3>
              <ul class="text-sm text-slate-600 text-left space-y-2 mb-4 list-disc pl-4 flex-grow">
            ...
            <div id="timeline-step-taxreturn" class="bg-white p-5 lg:p-6 rounded-2xl border border-slate-200 shadow-sm relative text-left flex flex-col items-start w-full transition-all duration-300 min-h-[380px] overflow-hidden">
              ...
              <h3 class="text-xl md:text-2xl font-black text-slate-900 mb-4 leading-tight">Annual Tax Return</h3>
              <ul class="text-sm text-slate-600 text-left space-y-2 mb-4 list-disc pl-4 flex-grow">
